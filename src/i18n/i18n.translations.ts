...
import { entityDeliveryDetailsEn, entityDeliveryDetailsEs } from './pages/entityDeliveryDetails'
...
export const es = {
    ...
    [namespaces.pages.entityDeliveryDetails]: entityDeliveryDetailsEs,
}
...
export const en = {
    ...
    [namespaces.pages.entityDeliveryDetails]: entityDeliveryDetailsEn,
}
